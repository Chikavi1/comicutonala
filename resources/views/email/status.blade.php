...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" alt="Image" border="0" class="center fixedwidth" src="https://i.ibb.co/sgWQT16/ico.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 77px; display: block;" title="Image" width="77"/>
...
<div style="color:#17202F;font-family:'Open Sans', Helvetica, Arial, sans-serif;line-height:120%;padding-top:20px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<div style="font-size: 12px; line-height: 14px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; color: #17202F;">
<p style="font-size: 14px; line-height: 28px; text-align: right; margin: 0;"><span style="font-size: 24px;"><span style="line-height: 33px; font-size: 28px;">Ventas</span><span style="font-size: 26px; line-height: 31px;"><strong><span style="line-height: 31px; font-size: 26px;">Un</span><span style="line-height: 31px; font-size: 26px;">i</span></strong></span></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<div style="background-image:url('https://i.ibb.co/J5npx0H/bg-wave-1.png');background-position:top center;background-repeat:repeat;background-color:#F4F4F4;">
<div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 700px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
<div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-image:url('https://i.ibb.co/fCx3Zn3/bg-wave-2.png');background-position:top center;background-repeat:repeat;background-color:#F4F4F4;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:700px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
...
<p style="font-size: 14px; line-height: 16px; margin: 0;"><strong><span style="font-size: 46px; line-height: 55px;">!Hola, <span style="color: #3d3bee; line-height: 55px; font-size: 46px;">{{$nombre}}</span>!</span></strong></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<div style="line-height: 18px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 12px; color: #555555;">
<p style="line-height: 30px; font-size: 12px; margin: 0;"><span style="font-size: 20px;"><strong>Muchas gracias por enviar tu solicitud para ser aceptado dentro de nuestra comunidad,para nosotros es muy importante poder tener un control de los vendedores para que nuestros usuarios puedan obtener informacion verídica de los mejores vendedores. </strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="line-height: 24px; font-size: 12px; margin: 0;text-align: center;"><span style="font-size: 16px;">El estado de su solicitud a <strong>{{$vendedor}}</strong>  es: </span><br /><span style="color: {{ $estado == 'aprobado' ? 'green' : 'red' }}
;font-size: 1.5em;font-weight: bold;">{{$estado}}</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<p style="font-size: 14px; line-height: 16px; margin: 0;"><span style=" font-size: 14px; line-height: 16px;"><span style="font-size: 24px; line-height: 28px; ><span style="line-height: 28px; font-size: 24px; >Recomendaciones: </span></span></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<li style="font-size: 14px; line-height: 25px;"><span style="font-size: 16px; background-color: transparent; line-height: 28px;">Cuando ya no pueda vender,cambie a "No Disponible".</span></li>
<li style="font-size: 14px; line-height: 25px;"><span style="font-size: 16px; background-color: transparent; line-height: 28px;">No Agregue fotos de dimensiones muy grandes.</span></li>
<li style="font-size: 14px; line-height: 25px;"><span style="font-size: 16px; line-height: 28px;">En la descripción puedes agregar tus redes sociales o información extra sobre tu negocio.</span></li>
<li style="font-size: 14px; line-height: 25px;"><span style="font-size: 16px; line-height: 28px;">De preferencia el numero que agregues a tu cuenta este vinculado con Whatsapp</span></li>
</ul>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://api.chikavi.com/profile" style="height:54pt; width:177pt; v-text-anchor:middle;" arcsize="13%" stroke="false" fillcolor="#3D3BEE"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:26px"><![endif]--><a href="http://api.chikavi.com/profile" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #1357c7; border-radius: 9px; -webkit-border-radius: 9px; -moz-border-radius: 9px; width: auto; width: auto; border-top: 1px solid #1357c7; border-right: 1px solid #1357c7; border-bottom: 1px solid #1357c7; border-left: 1px solid #1357c7; padding-top: 10px; padding-bottom: 10px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:45px;padding-right:45px;font-size:26px;display:inline-block;">
<span style="font-size: 16px; line-height: 32px;"><span style="font-size: 26px; line-height: 52px;"><strong>ir a tu perfil</strong></span></span>
</span></a>
...
<div style="background-image:url('https://i.ibb.co/fCx3Zn3/bg-wave-2.png');background-position:top center;background-repeat:repeat;background-color:#F4F4F4;">
<div class="block-grid" style="Margin: 0 auto; min-width: 320px; max-width: 700px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: transparent;">
<div style="border-collapse: collapse;display: table;width: 100%;background-color:transparent;">
<!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-image:url('https://i.ibb.co/fCx3Zn3/bg-wave-2.png');background-position:top center;background-repeat:repeat;background-color:#F4F4F4;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:700px"><tr class="layout-full-width" style="background-color:transparent"><![endif]-->
<!--[if (mso)|(IE)]><td align="center" width="700" style="background-color:transparent;width:700px; border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent;" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px; padding-top:5px; padding-bottom:0px;"><![endif]-->
...
<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;"><span style="color: #000000; font-size: 14px; line-height: 21px;"><strong>©2019 VentasUni</strong></span>, Luis Rojas.</p>
<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;">Tlaquepaque,Jal.Mexico</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
